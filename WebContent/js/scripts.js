/***************** Mustache Templates for gallery and Modals ***************** */
$(function () {
	...
	if(template) {
		...
		slidersPastosa.push(galleryItem('Lasanha de Carne com beringela', 'img/pastosa/lasanha-carne-beringela-1.jpg', 'img/pastosa/lasanha-carne-beringela-1.jpg,img/pastosa/lasanha-carne-beringela-2.jpg,img/pastosa/lasanha-carne-beringela-3.jpg,img/pastosa/lasanha-carne-beringela-4.jpg', 'Delicioso Lasanha carne beringela da fase pastosa'));
		...
		slidersPastosa.push(galleryItem('Lasanha de Frango com abobrinha', 'img/pastosa/lasanha-frango-abobrinha-1.jpg', 'img/pastosa/lasanha-frango-abobrinha-1.jpg,img/pastosa/lasanha-frango-abobrinha-2.jpg,img/pastosa/lasanha-frango-abobrinha-3.jpg', 'Delicioso Lasanha frango abobrinha da fase pastosa'));
		...
		var rendered = Mustache.render(template, {'produtos': slidersPastosa, 'cssClass': 'light-box'});
		$('#produtos-fase-pastosa').html(rendered);
		
		var slidersFit = new Array();
		
		slidersFit.push(galleryItem('Barra de Cereais', 'img/fit/barra-cereais-1.jpg', 'img/fit/barra-cereais-1.jpg', ''));
		slidersFit.push(galleryItem('Cookie de castanha de caju', 'img/fit/cookie-castanha-caju-1.jpg', 'img/fit/cookie-castanha-caju-1.jpg,img/fit/cookie-castanha-caju-2.jpg', ''));
		slidersFit.push(galleryItem('Brigadeiro funcional', 'img/fit/brigadeiro-funcional-1.jpg', 'img/fit/brigadeiro-funcional-1.jpg', ''));

		var rendered = Mustache.render(template, {'produtos': slidersFit, 'cssClass': 'light-box'});
		$('#produtos-linha-fit').html(rendered);
...
/***************** Modal Carousel ******************/
$(function () {
    var $galleryItem=$('a.expand[data-modal-images]');
    if ($galleryItem) {
